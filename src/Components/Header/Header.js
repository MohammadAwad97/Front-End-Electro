      ...
      <nav className="bg-[#272525] border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          {userId ? (
            ...
            <Link
              to="/register"
              className="flex items-center md:order-2 text-white"
              aria-current="page"
            >
              Register
            </Link>
          ...
          >
            ...
            >
              <li>
                <Link
                  to="/"
                  className="block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 text-white"
                  aria-current="page"
                >
                  Home
                </Link>
